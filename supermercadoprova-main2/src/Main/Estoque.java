...
public class Estoque {
    ...
    // BUG - letra A 
    /* A lógica era que os itens escritos
     * para adicionar na lista, não eram verificados
     * da forma correta, então aparecia a mensagem de item
     * "nao adicionado", pois aqui era um VOID e não retornava
     * nada, então transformei o método em Boolean. Complemento linha 21 do Pedido.
     * */
